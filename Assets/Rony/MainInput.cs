...
public partial class @MainInput: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""Camera"",
            ""id"": ""8df7e74b-0e23-4985-a056-e94ec5aca57d"",
            ""actions"": [
                {
                    ""name"": ""Drag"",
                    ""type"": ""Value"",
                    ""id"": ""0584810e-4073-4451-898b-183f656dc6f0"",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""884dff1f-e583-4579-87ed-8ef69b3a309f"",
    ...
    ~@MainInput()
    {
        UnityEngine.Debug.Assert(!m_Camera.enabled, "This will cause a leak and performance issues, MainInput.Camera.Disable() has not been called.");
    }
